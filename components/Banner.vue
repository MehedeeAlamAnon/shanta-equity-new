<template>
  ...
  <section class="banner bg-cover bg-no-repeat bg-bottom">
    <div
      class="banner-content bg-black bg-opacity-30 flex items-center min-h-xs sm:(min-h-screen-sm) lg:(min-h-screen-md) 2xl:(min-h-screen-895px)"
    >
      <div class="container mx-auto px-4">
        <h1
          class="max-w-full lg:(max-w-928px) text-30px leading-snug text-white sm:(text-48px leading-tight) md:(text-60px leading-tight) lg:(text-72px leading-tight) mb-5 2xl:(text-90px leading-tight max-w-1200px)"
        >
